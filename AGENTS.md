...
2. **Change `name` in `package.json`** away from `"narduk-enterprises-portfolio"`.
...
**Reference:** See `narduk-enterprises-portfolio-examples/nuxt.config.ts` for the full runtimeConfig block and `narduk-enterprises-portfolio-examples/AGENT_ANALYTICS.md` for automation script details.
...
**Reference:** See `narduk-enterprises-portfolio-examples/tests/` for example test files.
...
**Reference:** See `narduk-enterprises-portfolio-examples/server/utils/auth.ts` and `narduk-enterprises-portfolio-examples/app/composables/useAuth.ts`.
...
**Reference:** See `narduk-enterprises-portfolio-examples/content/templates/blog/` and `narduk-enterprises-portfolio-examples/app/pages/templates/blog/`.
...
1. Browse the components in `narduk-enterprises-portfolio-examples/app/components/ui/` — includes `HeroSection`, `FeatureGrid`, `PricingTable`, `TestimonialCarousel`, `ContactForm`, `CTABanner`.
2. Browse layouts in `narduk-enterprises-portfolio-examples/app/layouts/` — includes `blog.vue`, `dashboard.vue`, `landing.vue`.
...
**Reference:** See `narduk-enterprises-portfolio-examples/app/components/ui/` for the full set.
...
**Reference:** See `narduk-enterprises-portfolio-examples/app/components/AppFormCard.vue` and `narduk-enterprises-portfolio-examples/app/composables/useFormHandler.ts`.
